      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        <div className="lg:col-span-7">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-black leading-none tracking-tighter mb-10 text-white">
              FUTURE <br />
              <span className="text-transparent border-t-4 border-cyber-gold bg-clip-text bg-gradient-to-r from-cyber-gold to-white py-2">GARMENT</span> <br />
              LOGISTICS.
            </h1>
            
            <p className="max-w-xl text-lg text-white/50 font-light leading-relaxed mb-12 border-l-2 border-cyber-gold/30 pl-8">
            ...
            <div className="flex flex-wrap gap-8 items-center">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-white text-cyber-black px-12 py-6 rounded-sm text-xs font-black uppercase tracking-[0.3em] flex items-center gap-4 hover:bg-cyber-gold transition-all"
              >
...
const Capability = () => {
  ...
  return (
    <section id="expertise" className="py-32 px-6 bg-cyber-black relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {specs.map((spec, i) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="glass p-12 relative overflow-hidden group hover:border-cyber-gold/50 transition-colors"
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-100 transition-opacity">
                <span className="text-8xl font-display font-black text-white">0{i+1}</span>
              </div>
              
              <div className="relative z-10">
                <div className="w-14 h-14 bg-white/5 flex items-center justify-center rounded-sm mb-8 group-hover:glow-border transition-all">
                  {spec.icon}
                </div>
                <div className="text-[10px] font-black tracking-widest text-cyber-gold mb-2">{spec.meta}</div>
                <h3 className="text-3xl font-display font-black uppercase mb-4">{spec.title}</h3>
                <p className="text-white/50 font-light text-sm leading-relaxed max-w-sm">{spec.desc}</p>
                <div className="mt-8 pt-8 border-t border-white/5 flex items-center gap-4 text-[10px] font-bold tracking-widest text-white/30">
  ...
  return (
    <section id="about" className="py-32 px-6 relative z-10 overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none">
        <div className="w-[800px] h-[800px] bg-cyber-gold/5 blur-[200px] rounded-full mx-auto" />
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-24">
        <div className="lg:w-1/2">
          <motion.div 
            ...
            className="relative"
          >
            <div className="absolute -top-10 -left-10 w-40 h-40 border-l border-t border-cyber-gold/30 pointer-events-none" />
            <div className="absolute -bottom-10 -right-10 w-40 h-40 border-r border-b border-cyber-gold/30 pointer-events-none" />
            ...
            <div className="absolute top-1/2 -right-12 translate-x-1/2 bg-cyber-gold text-cyber-black p-8 rounded-sm shadow-2xl rotate-3">
              <div className="text-4xl font-display font-black leading-none">2024</div>
              <div className="text-[10px] font-black uppercase tracking-widest mt-1">FOUNDATION_LINK</div>
            </div>
          </motion.div>
        </div>

        <div className="lg:w-1/2">
          <span className="text-xs font-black uppercase tracking-[0.5em] text-cyber-gold mb-8 block">// LEGACY + VISION</span>
          <h2 className="text-5xl font-display font-black mb-10 leading-tight uppercase tracking-tighter">
          ...
          <div className="space-y-8 text-white/60 font-light leading-relaxed text-lg">
            ...
            <p className="border-l-4 border-cyber-gold pl-8 py-4 bg-white/5">
          ...
          <div className="mt-16 grid grid-cols-2 gap-12 border-t border-white/10 pt-12">
            <div>
              ...
              <div className="text-2xl font-display font-bold">KOLKATA_700082</div>
            </div>
            <div>
              <div className="text-[10px] font-black uppercase tracking-widest text-cyber-gold mb-2">OPERATIONAL_STATE</div>
              <div className="text-2xl font-display font-bold">ACTIVE_VERIFIED</div>
            </div>
          </div>
        </div>
      </div>
...
const Nexus = () => {
  return (
    <section id="contact" className="py-32 px-6 bg-cyber-black relative overflow-hidden z-10 border-t border-white/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <span className="text-xs font-black uppercase tracking-[0.5em] text-cyber-gold mb-8 block">// TERMINAL 01</span>
          <h2 className="text-7xl md:text-9xl font-display font-black mb-16 leading-[0.8] tracking-widest text-white/5 active-glow select-none">
            NEXUS<br />CONNECT
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 font-light truncate">tbsindia23@gmail.com</p>
            </div>
            <div className="space-y-4">
              <div className="text-[10px] font-black uppercase tracking-widest text-cyber-gold">GST_REGISTRY</div>
              <p className="text-white/60 font-light">19AAWFT0108L1ZO</p>
            </div>
          </div>
        </div>

        <div className="glass p-12 md:p-16 relative overflow-hidden flex flex-col justify-center">
          <div className="absolute top-0 right-0 w-24 h-24 border-t border-r border-cyber-gold/40" />
          
          <h3 className="text-3xl font-display font-black uppercase mb-12 flex items-center gap-4">
          ...
          <div className="space-y-6">
            <motion.a 
              ...
              className="flex items-center justify-between p-8 bg-white/5 border border-white/10 hover:border-cyber-gold transition-all group"
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-full bg-cyber-gold text-cyber-black flex items-center justify-center group-hover:glow-border transition-all">
                  <Facebook size={32} />
                </div>
                <div>
                  <div className="text-[10px] font-black tracking-widest text-cyber-gold mb-1 underline decoration-cyber-gold/30">ESTABLISH_CONNECTION</div>
                  <div className="text-2xl font-display font-bold">FACEBOOK_OFFICIAL</div>
                </div>
              </div>
              <ArrowRight size={24} className="text-white/20 group-hover:text-cyber-gold transition-colors" />
            </motion.a>
            ...
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-full bg-white text-cyber-black flex items-center justify-center group-hover:glow-border transition-all">
                  <Instagram size={32} />
                </div>
                <div>
                  <div className="text-[10px] font-black tracking-widest text-cyber-gold mb-1 underline decoration-cyber-gold/30">SYNC_VISUALS</div>
                  <div className="text-2xl font-display font-bold">INSTAGRAM_CORE</div>
                </div>
              </div>
              <ArrowRight size={24} className="text-white/20 group-hover:text-cyber-gold transition-colors" />
            </motion.a>
            ...
            <motion.a 
              ...
              rel="noopener noreferrer"
              whileHover={{ x: 10, scale: 1.02 }}
              className="flex items-center justify-between p-8 bg-cyber-gold/10 border border-cyber-gold/20 hover:border-cyber-gold transition-all group"
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-full bg-cyber-gold text-cyber-black flex items-center justify-center group-hover:glow-border transition-all">
                ...
                <div>
                  <div className="text-[10px] font-black tracking-widest text-cyber-gold mb-1 underline decoration-cyber-gold/30">DIRECT_UPLINK</div>
                  <div className="text-2xl font-display font-bold">WHATSAPP_LIVE</div>
                </div>
              </div>
              <ArrowRight size={24} className="text-white/20 group-hover:text-cyber-gold transition-colors" />
            </motion.a>
          ...
          <div className="mt-12 text-[10px] font-black uppercase tracking-[0.4em] text-white/20 text-center">
...
const Footer = () => {
  return (
    <footer className="py-20 px-6 border-t border-white/5 relative z-10 bg-cyber-black overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="text-3xl font-display font-black tracking-tighter flex items-center gap-2">
          TBS<span className="text-cyber-gold animate-pulse">_</span>LOG
        </div>
        
        <div className="flex gap-16 text-[10px] font-black uppercase tracking-[0.3em] text-white/30 font-display">
        ...
        <div className="text-[10px] font-black uppercase tracking-[0.4em] opacity-30 text-right">
          © 2024 Tirupati Balajee Sales <br />
  ...
  return (
    <div className="relative min-h-screen bg-cyber-black text-white selection:bg-cyber-gold selection:text-cyber-black overflow-x-hidden">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-10 right-10 z-50 w-20 h-20 bg-cyber-gold text-cyber-black flex items-center justify-center shadow-2xl transition-all"
      >
        <div className="relative">
          ...
          <motion.div 
            ...
            className="absolute -top-1 -right-1 w-3 h-3 bg-white rounded-full border-2 border-cyber-black" 
          />
        </div>
      </motion.a>
